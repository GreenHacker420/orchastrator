...
export function AgentLogs({ logs }) {
    ...
    return (
        <div className="flex-1 min-h-0 relative rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950/30 shadow-inner overflow-hidden">
            <ScrollArea className="h-full w-full p-4">
                <div className="space-y-3 font-mono text-sm leading-relaxed pb-4">
                    {logs.length === 0 && (
                    ...
                    <div ref={scrollRef} className="h-px w-full" /> {/* Auto-scroll anchor */}
                </div>
            </ScrollArea>
        </div>
    );
